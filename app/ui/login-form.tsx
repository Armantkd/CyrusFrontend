...
export default function LoginForm() {
  ...
  return (
    <form className="space-y-4">
      <div className="flex-1 rounded-lg bg-gray-50 px-8 pb-6 pt-10">
        <h1 className={`${lusitana.className} mb-5 text-3xl`}>
        ...
        <div className="w-full">
          <div>
            ...
            <div className="relative">
              <input
                className="peer block w-full rounded-md border border-gray-200 py-3 pl-10 text-base outline-2 placeholder:text-gray-500"
                id="email"
                type="email"
                name="email"
        ...
        <div className="mt-6">
          ...
          <Button
            ...
            className="w-full py-3 text-lg bg-gray-100">
        ...
        <div className="mt-4 text-center">
          <Link href="/register" className="text-lg font-medium text-blue-600 hover:underline">
            Register
          </Link>
        </div>
...
function LoginButton() {
  return (
    <Button type="submit" className="mt-6 w-full py-3 text-lg">
      Log in <ArrowRightIcon className="ml-auto h-5 w-5 text-gray-50" />
    </Button>
  );
}
